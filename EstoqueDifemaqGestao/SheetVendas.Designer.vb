...
Partial Public NotInheritable Class SheetVendas
    Inherits Microsoft.Office.Tools.Excel.WorksheetBase
    
    Friend WithEvents tblVendas As Microsoft.Office.Tools.Excel.ListObject
    ...
    Private Sub InitializeControls()
        Me.tblVendas = Globals.Factory.CreateListObject(Nothing, Nothing, "Planilha4:tblVendas", "tblVendas", Me)
    End Sub
...
Partial Friend NotInheritable Class Globals
    ...
    Private Shared _SheetVendas As SheetVendas
    
    Friend Shared Property SheetVendas() As SheetVendas
        Get
            Return _SheetVendas
        End Get
        Set
            If (_SheetVendas Is Nothing) Then
                _SheetVendas = value
            Else
