...
'''
<Microsoft.VisualStudio.Tools.Applications.Runtime.StartupObjectAttribute(7),  _
...
Partial Public NotInheritable Class Planilha7
    Inherits Microsoft.Office.Tools.Excel.WorksheetBase
    
    Friend WithEvents tblProdutos As Microsoft.Office.Tools.Excel.ListObject
    ...
    Public Sub New(ByVal factory As Global.Microsoft.Office.Tools.Excel.Factory, ByVal serviceProvider As Global.System.IServiceProvider)
        MyBase.New(factory, serviceProvider, "Planilha7", "Planilha7")
    End Sub
    ...
    Private Sub InitializeControls()
        Me.tblProdutos = Globals.Factory.CreateListObject(Nothing, Nothing, "Planilha7:tblProdutos", "tblProdutos", Me)
    End Sub
...
Partial Friend NotInheritable Class Globals
    ...
    Private Shared _Planilha7 As Planilha7
    
    Friend Shared Property Planilha7() As Planilha7
        Get
            Return _Planilha7
        End Get
        Set
            If (_Planilha7 Is Nothing) Then
                _Planilha7 = value
            Else
