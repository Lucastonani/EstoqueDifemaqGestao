...
Partial Public NotInheritable Class SheetEstoqueVisao
    Inherits Microsoft.Office.Tools.Excel.WorksheetBase
    
    Friend WithEvents tblEstoqueVisao As Microsoft.Office.Tools.Excel.ListObject
    ...
    Private Sub InitializeControls()
        Me.tblEstoqueVisao = Globals.Factory.CreateListObject(Nothing, Nothing, "Planilha1:tblEstoqueVisao", "tblEstoqueVisao", Me)
    End Sub
...
Partial Friend NotInheritable Class Globals
    ...
    Private Shared _SheetEstoqueVisao As SheetEstoqueVisao
    
    Friend Shared Property SheetEstoqueVisao() As SheetEstoqueVisao
        Get
            Return _SheetEstoqueVisao
        End Get
        Set
            If (_SheetEstoqueVisao Is Nothing) Then
                _SheetEstoqueVisao = value
            Else
