...
Partial Public NotInheritable Class Planilha3
...
Partial Friend NotInheritable Class Globals
    ...
    Private Shared _Planilha3 As Planilha3
    
    Friend Shared Property Planilha3() As Planilha3
        Get
            Return _Planilha3
        End Get
        Set
            If (_Planilha3 Is Nothing) Then
                _Planilha3 = value
            Else
