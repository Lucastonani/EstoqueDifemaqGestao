...
'''
<Microsoft.VisualStudio.Tools.Applications.Runtime.StartupObjectAttribute(8),  _
...
Partial Public NotInheritable Class Planilha8
    Inherits Microsoft.Office.Tools.Excel.WorksheetBase
    
    Friend WithEvents Produtos As Microsoft.Office.Tools.Excel.ListObject
    ...
    Public Sub New(ByVal factory As Global.Microsoft.Office.Tools.Excel.Factory, ByVal serviceProvider As Global.System.IServiceProvider)
        MyBase.New(factory, serviceProvider, "Planilha8", "Planilha8")
    End Sub
    ...
    Private Sub InitializeControls()
        Me.Produtos = Globals.Factory.CreateListObject(Nothing, Nothing, "Planilha8:Produtos", "Produtos", Me)
    End Sub
...
Partial Friend NotInheritable Class Globals
    ...
    Private Shared _Planilha8 As Planilha8
    
    Friend Shared Property Planilha8() As Planilha8
        Get
            Return _Planilha8
        End Get
        Set
            If (_Planilha8 Is Nothing) Then
                _Planilha8 = value
            Else
