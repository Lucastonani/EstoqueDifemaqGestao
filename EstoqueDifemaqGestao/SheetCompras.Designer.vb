...
Partial Public NotInheritable Class SheetCompras
    Inherits Microsoft.Office.Tools.Excel.WorksheetBase
    
    Friend WithEvents tblCompras As Microsoft.Office.Tools.Excel.ListObject
    ...
    Public Sub New(ByVal factory As Global.Microsoft.Office.Tools.Excel.Factory, ByVal serviceProvider As Global.System.IServiceProvider)
        MyBase.New(factory, serviceProvider, "Planilha3", "Planilha3")
    End Sub
    ...
    Private Sub InitializeControls()
        Me.tblCompras = Globals.Factory.CreateListObject(Nothing, Nothing, "Planilha3:tblCompras", "tblCompras", Me)
    End Sub
...
Partial Friend NotInheritable Class Globals
    ...
    Private Shared _SheetCompras As SheetCompras
    
    Friend Shared Property SheetCompras() As SheetCompras
        Get
            Return _SheetCompras
        End Get
        Set
            If (_SheetCompras Is Nothing) Then
                _SheetCompras = value
            Else
